...
namespace PedidosManejo.Controllers
{
    ...
    public class usuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsuarioID,Nombre,CorreoElectronico,Contraseña,RolID,FechaRegistro,Estado")] usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsuarioID,Nombre,CorreoElectronico,Contraseña,RolID,FechaRegistro,Estado")] usuario usuario)
        {
            if (ModelState.IsValid)
            {
