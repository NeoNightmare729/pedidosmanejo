...
namespace PedidosManejo.Controllers
{
    ...
    public class permisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PermisoID,NombrePermiso,Descripcion")] permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PermisoID,NombrePermiso,Descripcion")] permisos permisos)
        {
            if (ModelState.IsValid)
            {
